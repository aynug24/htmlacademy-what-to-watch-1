...
import {deleteFilm, fetchFilm, fetchSimilarFilms,} from '../../store/api-actions';
import {getActiveFilm, getIsLoading as getFilmIsLoading,} from '../../store/film-data/selectors';
import {getIsLoading as getSimilarFilmsIsLoading, getSimilarFilms,} from '../../store/similar-films-data/selectors';
